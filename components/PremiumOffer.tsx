      ...
      >
        <div className="relative w-full max-w-sm md:max-w-2xl lg:max-w-4xl mx-auto">
          <motion.div
            ...
            className="relative bg-gradient-to-br from-gray-900 to-black rounded-2xl shadow-2xl border border-gray-700/50 overflow-hidden"
          >
            {/* Close button */}
            <button
              onClick={handleClose}
            ...
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="p-6 md:p-8 lg:p-10 space-y-6">
                ...
                {/* Trust badges */}
                <div className="flex items-center justify-center md:justify-start gap-6 pt-4 border-t border-gray-800">
